...
class ReportShowControllerCopia extends Controller
{
    ...
    */
    ...
    public function show($param)
    {
        ...
        $nameFile = time() . $param['report_file'];

        $output = public_path() . '/upload/documentos/empresa/relatorios/' . $nameFile;
        ...
        $nameFile = '/upload/documentos/empresa/relatorios/' . $nameFile;
        $filename = $nameFile . '.' . $this->formato;
        return $filename;
        // // dd($filename);
