    ...
    $(function () {
        ...
        $('#wizard-validate').steps({
            ...
            onStepChanging: function (event, currentIndex, newIndex) {
                ...
                if ((currentIndex === 0)) {
                    return $(this).parsley().validate('A');
                }

                // validate 'information' section: data-parsley-group='information'
                if ((currentIndex === 1)) {
                    return $(this).parsley().validate('B');
                }

                // validate 'payment' section: data-parsley-group='payment'
                if ((currentIndex === 2)) {
                    return $(this).parsley().validate('C');
                }
                
                if ((currentIndex === 3)) {
                    return $(this).parsley().validate('D');
                }
            },
            ...
            onFinished: function () {
                ...
                // or display message ;)
                //alert('submitted!');
                document.getElementById('wizard-validate').submit();
            }
        });
    });
