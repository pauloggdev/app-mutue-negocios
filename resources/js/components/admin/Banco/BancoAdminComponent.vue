                ...
                <div class="row">
                    <form id="adimitirCandidatos" method="POST" action>
                        ...
                        <div class="col-xs-12 widget-box widget-color-green" style="left: 0%;">
                            ...
                            <div class="table-header widget-header">Todos bancos do Sistema</div>
                            ...
                            <div>
                                <table id="dynamic-table" class="tabela1 table table-striped table-bordered table-hover">
                                    ...
                                    <tbody>
                                        <tr v-for="banco in queryBancos" :key="banco.id">
                                            <td class="center">
                                                <label class="pos-rel">
                                                    <input type="checkbox" class="ace" />
                                                    <span class="lbl"></span>
                                            ...
                                            <td>{{banco.id}}</td>
                                            <td>{{banco.designacao}}</td>
                                            <td style="text-align:center">{{banco.sigla}}</td>
                                            <td class="hidden-480" style="text-align: center">
                                                <span v-if="(banco.status_id == 1)" class="label label-sm label-success" style="border-radius: 20px;">{{ banco.statu_geral.designacao }}</span>
                                                <span v-else class="label label-sm label-warning" style="border-radius: 20px;">{{ banco.statu_geral.designacao }}</span>

                                            </td>

                                            <td>
                                                <div class="hidden-sm hidden-xs action-buttons">
                                                    <a href="#editar_banco" data-toggle="modal" class="pink" @click.prevent="mostrarModalEditar(banco)" title="Editar este registo">
                                                        <i class="ace-icon fa fa-pencil bigger-150 bolder success text-success"></i>
                                                    </a>
                                                    <a data-toggle="modal" title="Eliminar este Registro" @click.prevent="deletarBanco(banco)" style="cursor:pointer;">
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header text-center">
                        ...
                        <h4 class="smaller">
                            <i class="ace-icon fa fa-plus-circle bigger-150 blue"></i> Editar Banco
                        </h4>
                    </div>
                                    ...
                                    <div class="second-row">
                                                ...
                                                <div id="dados_cliente" class="tab-pane in active">
                                                    <div class="form-group has-info">
                                                        <div class="col-md-6">
                                                            ...
                                                            <div class>
                                                                <input type="text" v-model="bancoData.designacao" id="designacao" class="col-md-12 col-xs-12 col-sm-4" :class="errors.designacao?'has-error':''" placeholder="Informe o nome" />
                                                        ...
                                                        <div class="col-md-3">
                                                            ...
                                                            <div class>
                                                                <input type="text" v-model="bancoData.sigla" id="sigla" class="col-md-12 col-xs-12 col-sm-4" :class="errors.sigla?'has-error':''" placeholder="Informe o sigla" />
                                                        ...
                                                        <div class="col-md-3">
                                                            ...
                                                            <div class>
                                                                <Select2 :options="optionsStatus" v-model="bancoData.status_id" placeholder="Selecione o status">
                                                                </Select2>
                                        ...
                                        <div class="clearfix form-actions">
                                            <div class="col-md-offset-3 col-md-9">
                                                <button class="search-btn" style="border-radius: 10px" @click.prevent="editarBanco">
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header text-center">
                        <button type="button" class="close red bolder" data-dismiss="modal">×</button>
                        <h4 class="smaller">
                            <i class="ace-icon fa fa-plus-circle bigger-150 blue"></i> Adicionar Banco
                        </h4>
                    </div>
                    <div class="modal-body">
                        <div class="row" style="left: 0%; position: relative;">
                            ...
                            <div class="col-md-12">
                                ...
                                <form enctype="multipart/form-data" class="filter-form form-horizontal validation-form" id>
                                    <div class="second-row">
                                                ...
                                                <div id="dados_cliente" class="tab-pane in active">
                                                    <div class="form-group has-info">
                                                        <div class="col-md-6">
                                                            ...
                                                            <div class>
                                                                <input type="text" v-model="banco.designacao" id="designacao" class="col-md-12 col-xs-12 col-sm-4" :class="errors.designacao?'has-error':''" placeholder="Informe o nome" />
                                                                <span v-if="errors.designacao" class="error">{{errors.designacao[0]}}</span>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3">
                                                            ...
                                                            <div class>
                                                                <input type="text" v-model="banco.sigla" id="sigla" class="col-md-12 col-xs-12 col-sm-4" :class="errors.sigla?'has-error':''" placeholder="Informe o sigla" />
                                                                <span v-if="errors.sigla" class="error">{{errors.sigla[0]}}</span>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3">
                                                            ...
                                                            <div class>
                                                                <Select2 :options="optionsStatus" v-model="banco.status_id" placeholder="Selecione o status">
                                                                </Select2>
                                                                <span v-if="errors.status_id" class="error">{{errors.status_id[0]}}</span>
                                        ...
                                        <div class="clearfix form-actions">
                                            <div class="col-md-offset-3 col-md-9">
                                                <button class="search-btn" style="border-radius: 10px" @click.prevent="salvarBanco">
                                                    <i class="ace-icon fa fa-check bigger-110"></i>
                                                    Salvar
                                                </button>
                                                &nbsp; &nbsp;
...
export default {
    ...
    methods: {
        ...
        mostrarModalEditar(banco) {

            this.bancoData = {};
            this.errors = [];
            this.bancoData = Object.assign({}, banco);
        ...
        listarStatus() {
            ...
            this.banco.status_id = this.status[0].id
        },
