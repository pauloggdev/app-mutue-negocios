  ...
  <section class="content">
    <div class="row">
      ...
      <div class="page-header" style="left: 0.5%; position: relative">
        <h1>Anulação de Facturas</h1>
      </div>
      <!-- /.row -->
      <div class="row">
        <div class="col-md-12">
          <div class="search-form-text">
            <div class="search-text">Anular Facturas</div>
          </div>
        </div>
      </div>
      <div
          ...
          <div class="col-md-2">
            ...
            <div class="input-group">
              <input
                type="text"
                disabled
                v-model="dataAnulacao.created_at"
                class="col-md-12 col-xs-12 col-sm-3"
                required
              />
              <span class="input-group-addon">
          ...
          <div class="col-md-3">
            ...
            <div class="input-group">
              <input
                type="text"
                disabled
                v-model="dataAnulacao.total_preco_factura"
                class="col-md-12 col-xs-12 col-sm-3"
                required
              />
              <span class="input-group-addon">
          ...
          <div class="col-md-3">
            ...
            <div class="input-group">
              <input
                type="text"
                disabled
                v-model="dataAnulacao.valor_a_pagar"
                class="col-md-12 col-xs-12 col-sm-3"
                required
              />
              <span class="input-group-addon">
          ...
          <div class="col-md-2">
            ...
            <div class="input-group">
              <input
                type="text"
                disabled
                v-model="dataAnulacao.valor_entregue"
                class="col-md-12 col-xs-12 col-sm-3"
                required
              />
              <span class="input-group-addon">
  ...
  methods: {
    ...
    AnularDocumento() {
      if (!this.dataAnulacao.descricao) {
        this.$toasted.global.defaultError({
          msg: "Informe o motivo da anulação da factura",
        });
        return;
      }
      Swal.fire({
       ...
       this.requestAnulacaoDocumento(result.isConfirmed);
      });
    },
    requestAnulacaoDocumento(retornarStock) {
     this.$loading(true);
      axios
        .post(
          `${this.router}/documentoAnuladoFacturas/salvar?retornarStock=${retornarStock}`,
          this.dataAnulacao
        )
        .then((documentoAnulado) => {
          if (documentoAnulado.status === 200) {
            ...
            axios
              .get(
                `${this.router}/imprimirDocumentoAnuladoFacturas/${documentoAnulado.data}?viaImpressao=1`,
                {
