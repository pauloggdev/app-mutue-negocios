                            ...
                            <div class="row">
                                ...
                                <div class="form-group has-info bold" style="left: 0%; position: relative">
                                    <div class="col-md-12">
                                        ...
                                        <textarea style="height: 70px;" v-model="descricao" class="col-xs-12" cols="10" rows="3"></textarea>
    ...
    methods: {
        ...
        async listarDadoFactura(idFactura) {
            ...
            if (factura.status == 200) {
                ...
                this.facturacao = Object.assign({}, factura.data);
                ...
                this.facturacao.factura.facturas_items.map((item, index) => {
                    ...
                    this.facturacao.factura.facturas_items[index].taxaDesconto = this.taxaDesconto(item)
                })
        ...
        taxaDesconto(item) {
            return ((item.desconto_produto * 100) / (item.preco_venda_produto * item.quantidade_produto)) / 100;
        },
        ...
        recalcularFactura(facturaItem, quantAtual) {
            ...
            this.facturacao.factura.facturas_items.map((item, index) => {
                ...
                if (facturaItem.id == item.id) {
                    ...
                    let valor_desconto = this.valor_desconto(item, quantAtual);
            ...
            // console.log(this.facturacao);return;

        },

        valor_desconto(produto, quantAtual) { //valor desconto por produto
            return ((produto.preco_venda_produto * quantAtual) * produto.taxaDesconto);
        },
        ...
        valor_retencao(item, quantAtual) {
            return this.valor_incidencia(item, quantAtual) * 0.065;
        },
        ...
        async salvarFacturaRetificada() {
            ...
            this.facturacao.factura.descricao = this.descricao;
            this.facturacao.factura.facturaRectificada = this.descricao;
            ...
            try {
                ...
                if (this.recalcular) {
                    ...
                    Swal.fire({
                        ...
                        axios.post(`${this.router}/salvarFacturasRecitificadas?retornarStock=${retornarStock}`, this.facturacao).then(res => {
                            ...
                            if (res.status == 200) {
                                ...
                                axios.get(`${this.router}/imprimirDocumentoRetificado/${res.data.id}/${this.facturacao.factura.id}?viaImpressao=1`, {
        ...
        requestRetificacaoDocumento(retornarStock) {

            // this.$loading(true)
            axios.post(`${this.router}/salvarFacturasRecitificadas?retornarStock=${retornarStock}`, this.facturacao)
