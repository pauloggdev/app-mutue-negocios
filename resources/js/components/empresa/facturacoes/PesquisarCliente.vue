...
<div id="info-cliente">
    ...
    <div class="col-md-12" id="area-result-pesquisa" v-if="searchQuery">
        <div class="user-dropdown-content">
            <div v-for="c in resultQuery" :key="c.id" class="user-dropdown-content-item" @click="adicionarCliente(c)">
                <a>
...
export default {
    ...
    methods: {
        ...
        async listar_clientes() {
            ...
            let response = await axios.get(`${router}/listarClienteFacturacao`);
        ...
        adicionarCliente(cliente) {
            ...
            this.$emit('onAddCliente', cliente);
        ...
        loadGestores() {
            axios.get(`${baseUrl}/empresa/gestores`).then(res => {
