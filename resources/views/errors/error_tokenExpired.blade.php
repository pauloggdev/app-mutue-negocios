		...
		<div class="row">
			<div class="col-md-12">
				<div class="error-template">
					<h1>
						Ups!</h1>
					<h2>Token encontra-se expirado, ou token já usado</h2>
					<div class="error-details">
						Cadastre novamente a sua empresa, e segue os passos de validação
					</div>
					<div class="error-actions">

						<a href="<?= env('APP_URL')?>" class="btn btn-primary btn-lg">
