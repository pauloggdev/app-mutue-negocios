                                            ...
                                            <div class="modal-dialog modal-default">
                                              <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                  ...
                                                  <a href="{{url('admin/usuarios')}}/{{$user->id}}/delete" class="bigger-10 btn btn-danger btn-flat widget-color-blue1" style="border-radius: 10px"> Eliminar</a>
                                                </div>
                                              </div>
                                            </div>
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="row" style="left: 0%; position: relative;">
                                                            <div class="col-md-12">
                                                                ...
                                                                <form method = 'POST' action='{!! url("usuarios")!!}/{!!$user->id!!}/update' enctype="multipart/form-data" class="filter-form form-horizontal" >
                                                                    @csrf
                        ...
                        <div class="modal-body">
                            <div class="row" style="left: 0%; position: relative;">
                                <div class="col-md-12">
                                    ...
                                    <form method = 'POST' action='{!!url("admin/usuarios")!!}' enctype="multipart/form-data" class="filter-form form-horizontal validation-form" id="validation-form">
                                        {!! csrf_field() !!}
                                        <input type = 'hidden' name = 'remember_token' value = '{{Session::token()}}'>
