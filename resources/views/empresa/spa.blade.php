    ...
    <div id="navbar" class="navbar navbar-default ace-save-state">
        ...
        <div class="navbar-container ace-save-state" id="navbar-container">
            <div class="navbar-header pull-left">
                <a href="<?= $router ?>/home" class="navbar-brand">
                    <small>MUTUE-NEGÓCIO</small>
                </a>
            </div>
            ...
            <ul class="nav nav-list">
                ...
                <li class="hover">
                    ...
                    <ul class="submenu">
                        ...
                        <li class="hover">
                            <a href="<?= $router ?>/funcoes-permissoes">
                ...
                <li class="hover">
                    ...
                    <ul class="submenu">
                        ...
                        <li class="hover">
                            <a href="<?= $router ?>/produtos-vendidos">
                                <i class="menu-icon fa fa-list"></i>
                ...
                <li class="hover">
                    ...
                    <ul class="submenu">
                        <li class="hover">
                            <a href="<?= $router ?>/facturacao/criar">
                                <i class="menu-icon glyphicon glyphicon-barcode"></i>
                                Facturação
                            </a>
                            <b class="arrow"></b>
                        ...
                        <li class="hover">
                            <a href="<?= $router ?>/facturas-proformas">
                                <i class="menu-icon fa fa-list"></i>
                ...
                <li class="hover">
                    ...
                    <ul class="submenu">
                        ...
                        <li class="hover">
                            <a href="<?= $router ?>/facturas/operacao-deposito-recibo">
                                <i class="menu-icon fa fa-caret-right"></i>
                                Déposito de valores - recibos </a>
                            <b class="arrow"></b>
                        </li>
                        <li class="hover">
                            <a href="<?= $router ?>/notacredito">
                                <i class="menu-icon fa fa-caret-right"></i>
                                Nota de Crédito
                            </a>
                            <b class="arrow"></b>
                        ...
                        <li class="hover">
                            <a href="<?= $router ?>/facturas/rectificacao">
                                <i class="menu-icon fa fa-caret-right"></i>
                        ...
                        <li class="hover">
                            <a href="<?= $router ?>/facturas/anulacao">
                                <i class="menu-icon fa fa-caret-right"></i>
                        ...
                        <li class="hover">
                            <a href="<?= $router ?>/produto/actualizar-stock">
                                <i class="menu-icon fa fa-caret-right"></i>
                                Actualizar estoque </a>
                            <b class="arrow"></b>
                        </li>
                        <li class="hover">
                            <a href="<?= $router ?>/produtos/entrada">
                                <i class="menu-icon fa fa-caret-right"></i>
                                Entrada de produtos
                            </a>
                            <b class="arrow"></b>
                        ...
                        <li class="hover">
                            <a href="<?= $router ?>/produtos/transferencia">
                                <i class="menu-icon fa fa-caret-right"></i>
                        ...
                        <li class="hover">
                            <a href="<?= $router ?>/pagamento/fornecedor">
                                <i class="menu-icon fa fa-caret-right"></i>
                ...
                <li class="hover">
                    <a href="<?= $router ?>/inventarios" style="color: #ffffff">
                        <i class="menu-icon glyphicon glyphicon-refresh"></i>
                        <span class="menu-text">Invetários</span>
                        <b class="arrow fa fa-angle-down"></b>
                    </a>
                </li>
