                ...
                <div class="second-row">
                    <div class="tabbable">
                        <div class="tab-content profile-edit-tab-content">
                            ...
                            <div class="form-group has-info bold" style="left: 0%; position: relative">
                                ...
                                <div class="col-md-4">
                                    <label class="control-label bold label-select2" for="cidadeCliente">E-mail de Contacto<b class="red fa fa-question-circle"></b></label>
                                    <div class="input-group">
                            ...
                            <div class="form-group has-info bold" style="left: 0%; position: relative">
                                ...
                                <div class="col-md-4">
                                    <label class="control-label bold label-select2" for="telefoneCliente">Telefone de Contacto<b class="red fa fa-question-circle"></b></label>
                                    <div class="input-group">
                    ...
                    <div class="clearfix form-actions">
                        <div class="col-md-offset-3 col-md-9">
                            <button class="search-btn" type="submit" style="border-radius: 10px" wire:click.prevent="Fornecedorupdate">
                                <span wire:loading.remove wire:target="Fornecedorupdate">
                                    <i class="ace-icon fa fa-check bigger-110"></i>
                                    Salvar
                                </span>
                                <span wire:loading wire:target="Fornecedorupdate">
