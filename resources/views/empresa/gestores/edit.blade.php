...
<section class="content">
    ...
    <div class="row" style="left: 0%; position: relative;">
        <div class="col-md-12">
            ...
            <form method="post" action="{{url('empresa/bancos/update/')}}/{{base64_encode($banco->id)}}"  class="filter-form form-horizontal" id="validation-form">
                @method('PUT')
                {{ csrf_field() }}
                        ...
                        <div class="tab-content profile-edit-tab-content" style="height: 200px;">
                            <div id="dados_user" class="tab-pane in active" style="left: 12%; position: relative">
                                <div class="form-group has-info">
                                    <div class="col-md-5">
                                        <label class="control-label" for="banco">Nome<b class="red"><i class="fa fa-question-circle bold text-danger"></i></b></label>
                                        <div class="">
                                            <input type="text" name="designacao" value="{{$banco->designacao}}" id="designacao" class="col-md-12 col-xs-12  col-sm-4" required/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-5">
                                        ...
                                        <div class="">
                                            <select name="status_id" style="height: 34px" class="col-md-12 col-xs-12  col-sm-4 select2" data-placeholder="Selecione o status" id="gestor">
                                                ...
                                                <option value="{{$statu->id}}"{{($statu->id == $banco->status_id)?'selected="selected"':''}}>{{$statu->designacao}}</option>
                                                @endforeach
                                            </select>
