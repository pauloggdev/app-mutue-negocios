                ...
                <div class="second-row">
                        ...
                        <div class="tab-content profile-edit-tab-content">
                            <div class="form-group has-info bold" style="left: 0%; position: relative">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select wire:model="role.status_id" class="col-md-12 select2" id="status_id" style="height:35px;<?= $errors->has('role.status_id') ? 'border-color: #ff9292;' : '' ?>">
                    ...
                    <div class="clearfix form-actions">
                        <div class="col-md-offset-3 col-md-9">
                            <button class="search-btn" type="submit" style="border-radius: 10px" wire:click.prevent="atualizarPerfil">
                                <span wire:loading.remove wire:target="atualizarPerfil">
                                    <i class="ace-icon fa fa-check bigger-110"></i>
                                    Salvar
                                </span>
                                <span wire:loading wire:target="atualizarPerfil">
                                    <span class="loading"></span>
                                    Aguarde...</span>
                            </button>
                            &nbsp; &nbsp;
                            <a href="{{ route('roles.index') }}" class="btn btn-danger" type="reset" style="border-radius: 10px">
