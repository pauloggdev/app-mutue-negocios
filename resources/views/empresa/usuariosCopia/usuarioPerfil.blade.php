@extends('layout.appEmpresa',['router'=>$router])
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content" style="width: 460px;">
            ...
            <div class="modal-body" style="">
                <form method='POST' action='<?= $router ?>/usuario/updateSenha/{{Auth::user()->id}}' class="form-horizontal validation-form" role="form">
                    {!! csrf_field() !!}
