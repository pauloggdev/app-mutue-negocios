                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="hidden-sm hidden-xs action-buttons">
                                                    <a class="" href="{{url('empresa/usuarios/edit')}}/{{$user->id}}"  class="pink" title="Editar este registo">
                                            ...
                                            <div class="modal-dialog modal-default">
                                              <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                  ...
                                                  <a href="{{url('empresa/usuarios/delete')}}/{{$user->id}}" class="bigger-10 btn btn-danger btn-flat widget-color-blue1" style="border-radius: 10px"> Eliminar</a>
                                                </div>
                                              </div>
                                            </div>
                                            ...
                                            <div class="modal-dialog modal-lg" style="left: 6%;  position: relative">
                                                <div class="modal-content">
                                                    <div class="modal-header text-center">
                                                        ...
                                                        <h4 class="smaller"><i class="ace-icon fa fa-pencil bigger-150 blue"></i> Alterar Utilizador</h4>
                                                    </div>
                                                    <div class="modal-body">
                                                        <div class="row" style="left: 0%; position: relative;">
                                                            <div class="col-md-12">
                                                                ...
                                                                <form method = 'POST' action='{!! url("empresa/usuarios/update")!!}/{!!$user->id!!}' enctype="multipart/form-data" class="filter-form form-horizontal">
                                                                    {{ csrf_field() }}
                        ...
                        <div class="modal-body">
                            <div class="row" style="left: 0%; position: relative;">
                                <div class="col-md-12">
                                    ...
                                    <form method = 'POST' action='{!!url("empresa/")!!}' enctype="multipart/form-data" class="filter-form form-horizontal" id="validation-form">
                                        {!! csrf_field() !!}
                                        <input type = 'hidden' name = 'remember_token' value = '{{Session::token()}}'>
                                                ...
                                                <div class="tab-content profile-edit-tab-content">
                                                    <div id="dados_user" class="tab-pane in active" style="left: 12%; position: relative">
                                                        ...
                                                        <div class="form-group has-info">
                                                            ...
                                                            <div class="col-md-5">
                                                                <label class="control-label" for="telefone_empresa">Tipo Utilizador</label>
                                                                <div class="">
                                                                    <select name="tipo_user_id" id="">
