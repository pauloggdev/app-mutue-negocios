                                                ...
                                                <table class="table table-striped table-bordered table-hover">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>{{ $facturaItem['descricao_produto']}}</td>
                                                            <td style="text-align: right">{{ number_format($facturaItem['preco_venda_produto']??0,2,',','.')}}</td>
                                                            <td style="text-align: center">{{ number_format($facturaItem['qty_anterior']??0,1,',','.')}}</td>
                                                            <td style="text-align: center;display: flex;justify-content: center;">
                                                                <input type="number" min="0" onkeyup="this.value = (this.value > <?= $facturaItem['quantidade_produto'] ?>? <?= $facturaItem['quantidade_produto'] ?>:this.value) || (this.value?this.value:0)" wire:mouseup="alterarQuantidadeItem({{$key}},$event.target.value)" wire:keyup="alterarQuantidadeItem({{$key}},$event.target.value)" class="form-control" style="width: 70px;" max="<?= $facturaItem['quantidade_produto'] ?>">
                                                            </td>
                    ...
                    <div class="clearfix form-actions">
                        <div class="col-md-offset-3 col-md-9">
                            <button class="search-btn" type="submit" style="border-radius: 10px" wire:click.prevent="emitirNotaCreditoRetificacaoFactura">
                                ...
                                <span wire:loading wire:target="emitirNotaCreditoRetificacaoFactura">Aguarde...</span>
                            </button>
