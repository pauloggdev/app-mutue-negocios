...
<html>
    <head>
        ...
        <title>Recibo de Pagamento|A5</title>
    </head>
    ...
    <body onload="window.print();">
        ...
        <div class="row" style="font-size: 8pt;border-bottom: 0.3px solid #403e3eb0!important; padding:5px;"></div>
        ...
        <br>
        @endfor
        <div class="row" style="font-size: 8pt;border: 1px solid black!important; padding:10px;"> 
        ...
        <div class="row" style="font-size: 8pt;border: 1px solid black!important; padding:10px;"></div>
        <div class="row" style="font-size: 8pt;">
