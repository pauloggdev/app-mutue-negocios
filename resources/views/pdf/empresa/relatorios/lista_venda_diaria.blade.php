...
<head>
    ...
    <title>Lista de vendas diaria</title>
...
<body onload="window.print();" style="font-size: 10px;">
    ...
    <main>
        ...
        <span style="text-align: left;">Venda efectuada no dia: {{date_format($facturas[0]['created_at'], 'd-m-Y')}}</span>
        ...
        <table class="table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td colspan="3">{{date_format($factura->created_at,'H:i:s')}}</td>
                </tr>
