...
<html>
    <head>
        <meta charset="utf-8">
        <title>{{$factura->tipo_documento->designacao}} | A5</title>
        <meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>

        <!-- Aqui é o estilo da tabela com bootstrap.min.css 3.3.7 -->
        <link rel="stylesheet" href="assets/css/factura_tabelas.css" />
        ...
        <div class="wrapper">
          <!-- Main content -->
            <section class="invoice">
                ...
                <div class="row">
                    <div class="">
                        <h2 class="page-header">
                            ...
                            @else
                            <span class="col-sm-4" style="font-size: 12pt;">{{mb_strtoupper($factura->nome)}}</span>
                            @endif
                            </span>
                ...
                <!-- info row -->
                <div class="row invoice-info" style="font-size: 8pt;">
                    <div class="">
                        <div class="col-sm-6 invoice-col pull-left" >
                            ...
                            <b style="margin-top: 55px;">{{mb_strtoupper($factura->tipo_documento->designacao)}}</b>
                        </div>
                        <!-- /.col -->
                ...
                <table class="table table-striped" style="font-size: 8pt;">
                    <tr>
                        ...
                        <th>FT {{$factura->facturaSerie}}/{{$factura->numSequenciaFactura}}</th>
                        @elseif($factura->tipo_documento=="FACTURA PROFORMA")
                        <th>FP {{$factura->facturaSerie}}/{{$factura->numSequenciaFactura}}</th>
                        @elseif($factura->tipo_documento=="FACTURA RECIBO")
                        <th>FR {{$factura->facturaSerie}}/{{$factura->numSequenciaFactura}}</th>
                        @endif
                        <th>Moeda: {{mb_strtoupper($factura->moeda)}}</th>
                        <th>Câmbio: {{number_format($factura->cambio,2,",",".")}}</td></th>
                        @if(($factura->tipo_documento =="FACTURA") || ($factura->tipo_documento=="FACTURA RECIBO"))
                    ...
                    <div class="col-xs-12 table-responsive">
                        <table class="table table-striped">
                            ...
                            <tr>
                                ...
                                <td>{{number_format($item->preco_venda_produto,2,",",".")}}</td>
                ...
                <div class="row">
                    <div class="col-md-4 pull-left" style="font-size: 8pt;">
                ...
                <br><br><br>
                <footer style="border: 1px solid black!important; font-size: 7pt;">
