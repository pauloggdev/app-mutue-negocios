...
<html lang="en">
    ...
    <body onload="window.print();">
        ...
        <section>
            <div class="cliente">
                <div class="factura">{{$factura->tipo_documento}} REF:{{$factura->nextFactura}}</div>
                <ul id="notices" class="notice">
                    @if($factura->tipo_documento ==2)
                    <li>{{$factura->numeracaoFactura}}</li>
                    ...
                    <li>NIF: {{$factura->nif_cliente == '999999999' ? 'Consumidor final': $factura->nif_cliente}}</li>
                    <li>Telefone: {{$factura->telefone_cliente}}</li>
                    <li>E-Mail: {{$factura->email_cliente}}</li>
                    <li>Conta N.º: {{$factura->conta_corrente_cliente}}</li>
                </ul>
            </div>
        </section>
        ...
        <table class="table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td style="text-align: right;">{{number_format($item->quantidade_produto,2,",",".")}}</td>
        ...
        <footer>
            ...
            <div class="col-md-3 pull-left">
                ...
                <ul>
                    ...
                    <li style="font-weight: bolder;">{{mb_strtoupper(substr($factura->hashValor, 0, 4))}}-Processado por programa Certificado nº X/AGT/2020 (Mutue-Negócios)
                    </li>
                </ul>
            </div>
            <br>
            <span style="font-weight: bolder;">Operador: {{$factura->operador}}</span>
            <br><br><br>
