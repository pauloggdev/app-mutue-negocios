        ...
        <div class="row" style="font-size: 9pt;">
            <div style="float: left; width: 100px; margin-right:30px;">
                ...
                @if(!empty($factura->logotipo))
                    <img  alt="200x200" src="/storage/<?=$factura->logotipo?>" style="max-width: 100%; border-radius: 30px; height: 72px; width: 75px; left: 14px; position: relative" />
                @else
            ...
            <div class="pull-left" style="font-size: 8pt;">
                <table class="table table-striped">
                    <tr>
                        ...
                        <th>Incid./Qtd</th>
                        <th>IVA</th>
                        <th>Motivo de isenção/código</th>
                    </tr>
                    @forelse ($fatura_items as $key => $item)
                    <tr>
