...
<html lang="pt-br">
    <head>
        ...
        <link rel="stylesheet" href="{{asset('assets/front_office/assets/css/style.css')}}">         <link rel="stylesheet" href="{{asset('assets/front_office/assets/css/style.css')}}">        <link rel="stylesheet" href="{{asset('assets/front_office/assets/css/style.css')}}">
                    ...
                    <form method="POST" action="{{ route('register') }}" id="validation-form"  enctype="multipart/form-data">
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-md-2 mb-4">
                                ...
                                <input type="text" name="cidade" value="{{ old('cidade')}}" placeholder="Cidade. Ex:Luanda" class="form-control" id="cidade" required>
