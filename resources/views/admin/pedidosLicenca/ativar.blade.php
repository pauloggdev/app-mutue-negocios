        ...
        <div class="col-md-12">
            ...
            <div class="tabbable" style="margin-top:30px">
                ...
                <div class="tab-content profile-edit-tab-content">
                    ...
                    <div>
                        <form action="{{ route('pedidoLicencaAtivarAdmin', $pedido->id) }}" method="post">
                            @csrf
                            <button id="botoes" type="submit" style="margin-top:20px" class="btn btn-success widget-box widget-color-blue">ATIVAR LICENÇA</button>
                        </form>
                    </div>
