                    ...
                    <div class="tabbable">
                        <div class="tab-content profile-edit-tab-content">
                            ...
                            <div class="form-group has-info bold" style="left: 0%; position: relative">
                                ...
                                <div class="col-md-4">
                                    <label class="control-label bold label-select2" for="foto">Foto</label>
                                    <div class="input-group">
                                        <input type="file" wire:model="utilizador.foto" class="form-control" id="foto" style="height: 35px; font-size: 10pt" />
                                    </div>
                                </div>
                            </div>
                        </div>
